...
class MyHomeScreen extends React.Component {
  ...
  render() {
      return ( 
        <View>
          <Image source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/FH_Dortmund-logo.svg/1200px-FH_Dortmund-logo.svg.png' }}
            style= {{ width: '100%', height:250, resizeMode: 'contain' }}></Image>
          <Text>Vergleich von Mobile App Frameworks zur Cross-Platform Entwicklung</Text>
        </View>
      );
  }
}
